...
| task-management-013 | New Task (+ Config Builder) | task-management | `spec-ready` | `feat/task-management/013-task-new` | spec v3.1.7；規格狀態：Draft；prototype 迭代（資料集預覽、循序關係三元組建構器）已於 PR #93 合併 |
