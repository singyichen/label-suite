...
| task-management-013 | New Task (+ Config Builder) | task-management | `spec-ready` | `feat/task-management/013-task-new` | spec v4.0.0；規格狀態：Draft；Task New Step 1/2 僅提供 8 種 output type，移除 `entity_relation`、`boundary`，並遷移三項 config key 與顯示名稱 |
