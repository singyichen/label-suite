...
> **產品檔案（2）**：`design/prototype/pages/annotation/annotation-list.html`、`design/prototype/pages/annotation/annotation-workspace.data.js`（**動工後修正**：原列的 `design/prototype/pages/task-management/task-detail.data.js` 不含任何審核狀態，見下方 7.4 修正說明，已自清單移除。）
