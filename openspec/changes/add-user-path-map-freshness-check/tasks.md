...
- [x] 2.2 Green：只修改 `scripts/check-user-path-map-freshness.mjs`，依 approved QA contract 與 amended design 實作 FR-004～FR-007；不得修改 QA contract、HTML、prototype 或 screen inventory。 [@senior-devops]
