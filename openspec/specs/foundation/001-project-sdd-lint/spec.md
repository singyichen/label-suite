...
## Purpose
Project SDD lint 的 derived capability；正典為 `specs/foundation/001-project-sdd-lint/spec.md` v1.2.0。本變更實作正典 FR-001–FR-010、AC-1.1–AC-5.6 與 SC-001–SC-009，包含 Stage 3 的 same-trust-root generator boundary 與 control-character pathname preflight。
