 ...
 * are untouched.
 *
 * issue #815: every T017 oft-01-final-exception fixture below is retargeted
 * at T016 ofm-05-final-exception, its same-shape migrated successor (both
 * disputed · awaiting arbitration) -- T017 itself is retired.
 */
