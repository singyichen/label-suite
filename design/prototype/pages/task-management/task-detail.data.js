...
(function (global) {
  ...
  var profiles = {
    ...
    T015: {
      taskCategories: ['classification'],
      taskInputTypes: ['single_item'],
      /* issue #868: designated arbiters are excluded from NEW review
         assignment, so the natural roster order no longer needs issue
         #824's T015-only workaround that moved chen to the end. The
         effective assignment pool is wang/li/lin; chen stays reserved for
         disputes through arbiterIds. */
      reviewerIds: ['reviewer_wang', 'reviewer_li', 'reviewer_chen', 'reviewer_lin'],
      arbiterIds: ['reviewer_chen'],
      outputs: [
        {
