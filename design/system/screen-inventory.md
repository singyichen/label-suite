...
>
> **Prototype 內容雜湊：** `37bb3c3870b2`——對 `design/prototype/pages` · `design/prototype/index.html` 目前的實際位元組內容計算，內容不變則雜湊不變，不隨 commit 前進而改變。
...
| 11 | 標記工作區 | [`015-annotation-workspace`](../../specs/annotation/015-annotation-workspace/spec.md) FR ×156 · SC ×46<br>[`008-sidebar-navbar-shared`](../../specs/shared/008-sidebar-navbar-shared/spec.md) FR ×56 · SC ×39 | [`pages/annotation-workspace.md`](pages/annotation-workspace.md) | `annotation/annotation-workspace-*.spec.ts`（31 檔） | ⚠ 未定義 | annotator / reviewer | default、唯讀（已定稿）、提交驗證錯誤、空審核單元 | 59 | `features/annotation` | `shared/`：4 · `features/annotation/`：2 |
