...
>
> **Prototype 來源 commit：** `5d1e174713ea`（2026-09-24）——`design/prototype/pages` · `design/prototype/index.html` 的最後一次變更。
