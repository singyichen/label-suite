...
>
> **Prototype 來源 commit：** `0db3450`（2026-08-26）——`design/prototype/pages` · `design/prototype/index.html` 的最後一次變更。
...
| 11 | 標記工作區 | [`015-annotation-workspace`](../../specs/annotation/015-annotation-workspace/spec.md) FR ×131 · SC ×39<br>[`008-sidebar-navbar-shared`](../../specs/shared/008-sidebar-navbar-shared/spec.md) FR ×48 · SC ×34 | [`pages/annotation-workspace.md`](pages/annotation-workspace.md) | `annotation/annotation-workspace-*.spec.ts`（31 檔） | ⚠ 未定義 | annotator / reviewer | default、唯讀（已定稿）、提交驗證錯誤、空審核單元 | 45 | `features/annotation` | `shared/`：4 · `features/annotation/`：2 |
