...
>
> **Prototype 來源 commit：** `c14522e3b06a`（2026-09-18）——`design/prototype/pages` · `design/prototype/index.html` 的最後一次變更。
