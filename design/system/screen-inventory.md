...
>
> **Prototype 來源 commit：** `a8fd0e55b0db`（2026-09-01）——`design/prototype/pages` · `design/prototype/index.html` 的最後一次變更。
