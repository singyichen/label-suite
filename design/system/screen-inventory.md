...
>
> **Prototype 來源 commit：** `436ddb1f7513`（2026-09-17）——`design/prototype/pages` · `design/prototype/index.html` 的最後一次變更。
