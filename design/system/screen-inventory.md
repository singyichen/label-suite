...
>
> **Prototype 內容雜湊：** `619135347df1`——對 `design/prototype/pages` · `design/prototype/index.html` 目前的實際位元組內容計算，內容不變則雜湊不變，不隨 commit 前進而改變。
