...
**Status**: Accepted
**Date**: 2026-04-03
**Superseded in part by**: [ADR-033](033-formal-e2e-directory-location.md) — the *Playwright Test Structure* section's root directory moves from `frontend/tests/` to root `e2e/[module]/`. The `frontend/src/` vertical feature slicing that is this ADR's actual decision is unchanged.
