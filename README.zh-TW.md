...
2. **配置驅動的任務工作流**
   將任務設定、Dry Run 驗證、正式標記與資料集分析整合為可重複執行的學術 NLP 工作流。
...
- 提供可重用標記工具包，解決學術實驗室中低效臨時流程的實務痛點。
...
gantt
    ...
    資料集分析模組設計                           :p2d, 2026-11-01, 2026-12-01
    ...
    資料集分析與匯出功能                         :p3d, 2027-07-01, 2027-11-01
...
- [ ] 調研 Label Studio，找出架設、易用性與資料集分析上的痛點
...
- [ ] 設計 2–3 個核心展示場景（透過 Config 啟動任務、Dry Run 驗證、資料集分析）
