...
| Rule | Do | Don't |
|------|----|----- |
| **No emoji icons** | Use Lucide SVG icons (sole icon library — ADR-030) | Use emojis like 🎨 🚀 ⚙️ as UI icons |
...
- [ ] All icons from Lucide (the project's single icon set — ADR-030)
